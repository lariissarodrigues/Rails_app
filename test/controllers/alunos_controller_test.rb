...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { email: @aluno.email, nome: @aluno.nome, telefone: @aluno.telefone } }, as: :json
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { email: @aluno.email, nome: @aluno.nome, telefone: @aluno.telefone } }, as: :json
    assert_response 200
  end
